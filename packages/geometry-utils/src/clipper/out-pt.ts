...
export default class OutPt {
  ...
  constructor(
    index: number = 0,
    point: NullPtr<Point> = null,
    next: NullPtr<OutPt> = null,
    prev: NullPtr<OutPt> = null
  ) {
    this.index = index;
  ...
  public getBottomPt(): OutPt {
    ...
    while (outPt2 !== outPt1) {
      if (outPt2.point.y > outPt1.point.y) {
        ...
        outPt2.point.y == outPt1.point.y &&
                outPt2.point.x <= outPt1.point.x
      ) {
  ...
  public static joinHorz(
    ...
    const direction1: DIRECTION =
            op1.point.x > op1b.point.x ? DIRECTION.LEFT : DIRECTION.RIGHT;
    const direction2: DIRECTION =
            op2.point.x > op2b.point.x ? DIRECTION.LEFT : DIRECTION.RIGHT;
